...
func (x *InstanceSetting) GetAiSetting() *InstanceSetting_AiSetting {
	if x != nil {
		if x, ok := x.Value.(*InstanceSetting_AiSetting_); ok {
			return x.AiSetting
		}
	}
	return nil
...
type InstanceSetting_AiSetting_ struct {
...
func (*InstanceSetting_AiSetting_) isInstanceSetting_Value() {}
...
type InstanceSetting_AiSetting struct {
	...
	AiServiceUrl  string `protobuf:"bytes,1,opt,name=ai_service_url,json=aiServiceUrl,proto3" json:"ai_service_url,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InstanceSetting_AiSetting) GetAiServiceUrl() string {
	if x != nil {
		return x.AiServiceUrl
	}
	return ""
}
...
const file_api_v1_instance_service_proto_rawDesc = "" +
	...
	"\x19GetInstanceProfileRequest\"\x90\x12\n" +
	...
	"\n" +
	"ai_setting\x18\x05 \x01(\v2'.memos.api.v1.InstanceSetting.AiSettingH\x00R\taiSetting\x1a\xf8\x04\n" +
	...
	"\tnsfw_tags\x18\n" +
	" \x03(\tR\bnsfwTags\x1a1\n" +
	"\tAiSetting\x12$\n" +
	"\x0eai_service_url\x18\x01 \x01(\tR\faiServiceUrl\"N\n" +
	"\x03Key\x12\x13\n" +
...
func file_api_v1_instance_service_proto_init() {
	...
	file_api_v1_instance_service_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*InstanceSetting_AiSetting_)(nil),
	}
	type x struct{}
